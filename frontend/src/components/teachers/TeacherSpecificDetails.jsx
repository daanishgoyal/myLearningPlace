...
class TeacherSpecificDetails extends Component {
  ...
  onBookAppointmentSelect = () => {
    try {
      ...
      const { teacherData, currentUser, skill, selectedDay, selectedSlot } =
        this.state;
            ...
            <div className="modalClass">
              ...
              >
                ...
                <Modal.Body>
                  <Dropdown>
                    Select Day
                    {[...slotsAvailable.keys()].map((day, index) => {
                      return (
                        <div key={index}>
                          <div className="radio ms-4">
                            <label>
                              <input
                                type="radio"
                                value={day}
                                checked={this.state.selectedDay === day}
                  ...
                  <Dropdown>
                    Select Slot
                    {slotsForSpecificDay.map((slot, index) => {
                      return (
                        <div key={index}>
                          <div className="radio ms-4">
                            <label>
                              <input
                                type="radio"
                                value={slot}
                                checked={this.state.selectedSlot === slot}
                ...
                <Modal.Footer>
                  <Button onClick={() => this.onBookAppointmentSelect()}>
                    Confirm Booking
                  </Button>
                </Modal.Footer>
              </Modal>
  ...
  render() {
    ...
    const { teacherSchedule, slotsAvailable, slotsForSpecificDay } = this.state;
    let name = "";
